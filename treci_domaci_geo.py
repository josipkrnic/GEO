...
plt.show()
#iz ovih grafova vidimo da anomalija vode ne vrijedi za morsku vodu, budući da nemamo ekstremnu vrijednost u funkciji ro(T), već vidimo da graf kreće od maksimalne vrijednosti gustoće i
#nastavlja padati za sve veće temperature, pa možemo zaključiti da je gustoća maksimalna taman negdje pred smrzavanje morske vode
#iz eksperimenata (podaci nađeni na internetu) uočeno je da se temperatura maksimalne gustoće smanjuje povećavanjem saliniteta od 0 (gdje je maks. gustoća na T = 4°C),
#do cca 25 g/kg, gdje se temp. maks. gustoće praktički podudara s temperaturom ledišta morske vode, i taj se trend nastavlja daljnjim povećanjem saliniteta 
